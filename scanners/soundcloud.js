...
//LOOPS
console.log("Soundcloud scanner injected");
chrome.runtime.sendMessage({ text: "TABID_REQUEST" }, (tab) => {
  ...
  async function dataLoop() {
    ...
    let title = document.querySelector(`.playbackSoundBadge__title > a`).getAttribute("title")
    ...
    detectPause = config.soundcloud.detectPause
