...
chrome.runtime.sendMessage({ text: "TABID_REQUEST" }, (tab) => {
  ...
  async function dataLoop() {
    ...
    if(data.chapterName == ""){
      data.chapterName = document.querySelectorAll('div[id="upload-info"]')[0].querySelector("ytd-channel-name > .ytd-channel-name > .ytd-channel-name > .ytd-channel-name > a").innerHTML || ""
    }
